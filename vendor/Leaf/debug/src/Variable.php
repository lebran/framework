...
class Variable
{
    ...
    {
        $str = '<span style="color: blue">array </span>(<span style="color: orange">'.count(
                $arr
            )."</span>)<br />".self::getLvlDelim()."{<br />";
        self::$lvl++;
    ...
    {
        return '<span style="color: blue">string </span>(<span style="color: orange">'.mb_strlen(
            $str
        ).'</span>) "<span style="color: green">'.$str.'</span>"';
    }

    protected static function object($obj)
    {
        $obj = (array)$obj;
        $str = '<span style="color: blue">object </span>(<span style="color: orange">'.count(
                $obj
            )."</span>)<br />".self::getLvlDelim()."{<br />";
        self::$lvl++;
